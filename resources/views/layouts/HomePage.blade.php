                    ...
                    <div class="col-10">
                        <nav id="primary_nav_wrap">
                            <ul>
                                ...
                                <li class="current-menu-item"><a href="{{ route('index') }}"
                                                                 class="hover-underline-animation">Home</a></li>
                                @foreach($categories as $category)
                                    <li><a href="{{ route('category',['id'=>$category->CategoryID]) }}"
                                           class="hover-underline-animation">{{ $category->CategoryName }}</a>
                                    </li>
                                @endforeach
                    ...
                    <div class="col-10">
                        <form action="{{ route('searchProcess') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <button type="submit" style="border: none; background: inherit"><img
                                                src="https://img.icons8.com/ios-glyphs/30/000000/search.png"
                                                style="margin-top: 24px; margin-left: 10px;"/></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<div class="footer">
    <div class="footer-content">
        <div class="footer-content-emailadd">
            <strong><h3 style="font-weight: 800;text-align: center; font-size: 18px ; color: #ffffff; ">Get Product
                    Updates, Exclusive Offers & 10% Off Your First Order</h3></strong>
            <div class="email-address">
                <div class="email-address-input">
                    <form action="#">
                        <input type="text" placeholder="Email Address" class="form-control"
                               style="height: 45px;margin-top: 30px ;width: 450px; display: inline;">
                        <button type="button" class="btn btn-outline-danger" style="height: 45px; width: 88px;">Send
                        </button>
                    </form>
                </div>
            </div>
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col-3" style="text-decoration: none;">
                                ...
                                <br>
                                <p><a href="" class="hover-underline-animation"
                                      style="text-decoration: none; color: #ffffff;">About</a></p>
                                <p><a href="" class="hover-underline-animation"
                                      style="text-decoration: none; color: #ffffff;">Legal</a></p>
                                <p><a href="" class="hover-underline-animation"
                                      style="text-decoration: none; color: #ffffff;">Support</a></p>
                                <p><a href="" class="hover-underline-animation"
                                      style="text-decoration: none; color: #ffffff;">Press Release</a></p>
                            </div>
                            <div class="col-3">

    ...
    <div class="grid">
        ...
        @csrf
            <div class="form__field">
                ...
                <input id="email" type="email" name="email" class="form__input @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email" required autocomplete="email" autofocus>
